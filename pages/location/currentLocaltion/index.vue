    ...
    <view class="page-content">
      <view v-if="!showWebview">
        ...
        <view class="search-bar">
          <view class="search-input-container">
            <image src="https://www.xiaobei.space/static/icons/location/search.png" class="search-icon" />
            <input 
              type="text" 
            ...
            >
              ...
              <view class="card-info">
                <view class="card-title" >
                  ...
                  <image src="https://www.xiaobei.space/static/icons/common/phone.png" class="phone-icon" @click="onClickShowPhone(item)" />
                </view>
      ...
      <view class="webview-header" v-if="showWebview">
        <cover-view class="cover-back-btn" @click="goBackToList" v-if="showWebview">
          <cover-image src="https://www.xiaobei.space/static/icons/common/left.png" class="cover-back-icon"></cover-image>
        </cover-view>
        ...
        <view class="phone-selector-list">
          ...
          >
            <view class="phone-item-left">
              <image src="https://www.xiaobei.space/static/icons/location/userPhone.png" class="phone-user-icon" />
            ...
            <view class="phone-item-right">
              ...
              <image src="https://www.xiaobei.space/static/icons/common/phone.png" class="phone-call-icon" />
            </view>
          </view>
        </view>
      </view>
...
export default {
  ...
  computed: {
    showImgUrl() {
      return type => {
        return type === 1 ? 'https://www.xiaobei.space/static/icons/location/showCommunity.png' : 
               type === 2 ? 'https://www.xiaobei.space/static/icons/location/showFactory.png' : 
